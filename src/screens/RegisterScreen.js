            ...
            <Center flex={1} px={4}>
                <Box w="100%" maxW="300px">
                    <VStack space={4}>
                        ...
                        {['student', 'pwd', 'senior citizen'].includes(classification) && (
                            <>
                                ...
                                {selectedImage && (
                                    <Center>
                                        <Image
                                            source={{ uri: selectedImage === "" ? require("../assets/img/no-image.png") : selectedImage }}
                                            style={{ height: 250, width: 250, borderWidth: 1, borderColor: "#29B79D" }}
